...
Q_IMPORT_QML_PLUGIN(Senior_design_uiPlugin)
Q_IMPORT_QML_PLUGIN(Senior_design_uiContentPlugin)

const char mainQmlFile[] = "qrc:/qt/qml/Senior_design_uiContent/App.qml";
